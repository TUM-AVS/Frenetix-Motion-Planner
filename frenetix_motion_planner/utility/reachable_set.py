...
class ReachSet(object):
    ...
    def __init__(
        ...
        self.reach_set_params = load_reach_set_json(work_dir)
    ...
    def calc_reach_sets(self, ego_state, obstacle_list=None):
        ...
        for obstacle in obstacles:
            ...
            if o_id != self.ego_id:
                ...
                srs = reachable_set_simple.simple_reachable_set(
...
def load_reach_set_json(work_dir):
    """
    ...
    """
    reach_set_config_path = os.path.join(work_dir, 'configurations',
        'reachable_set.json',
    )
